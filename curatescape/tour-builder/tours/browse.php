...
<div id="content">
	...
	<h2 class="query-header"><?php echo __('Todas las %1$s: %2$s', $label, total_tours());?></h2>
		<div id="primary" class="browse">
		    ...
		    if( has_tours_for_loop() ){
				...
				foreach( $tours as $tour ){ 
					...
					$html .= '<div>';
					$html .= '<h3 class="home-tour-title"><a href="' . WEB_ROOT . '/tours/show/'. tour('id').'">' . tour('title').'</a></h3><span class="total">'.__('%s Ubicaciones',mh_tour_total_items($tour)).'</span>';
